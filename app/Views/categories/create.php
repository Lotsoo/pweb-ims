    ...
    <div class="glass-card shadow-lg rounded-xl overflow-hidden p-8">
        ...
        <form action="<?= base_url('categories/store') ?>" method="post">
            ...
            <div class="mb-8">
                ...
                <textarea name="description" id="description" rows="4" class="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"><?= old('description') ?></textarea>
            </div>
