        ...
        <tbody class="divide-y divide-gray-200">
            <?php if (!empty($categories)): ?>
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-white"><?= esc($category['name']) ?></td>
                    <td class="px-6 py-4 text-sm text-white"><?= esc($category['description']) ?></td>
