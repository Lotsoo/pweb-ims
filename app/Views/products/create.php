...
<div class="max-w-2xl">
    <div class="bg-card border border-border rounded-xl p-6">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-foreground">Informasi Produk</h2>
            <p class="text-sm text-muted-foreground mt-1">Isi detail produk baru di bawah ini</p>
        </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="1" name="price" id="price" value="<?= old('price') ?>" required
                ...
                <!-- Image Upload -->
                <div>
                    <label for="image" class="block text-sm font-medium text-foreground mb-2">Gambar Produk <span class="text-destructive">*</span></label>
                    <div class="relative">
                    ...
                    <p class="mt-1.5 text-xs text-muted-foreground">Format: JPG, PNG, GIF. Maksimal 2MB</p>
